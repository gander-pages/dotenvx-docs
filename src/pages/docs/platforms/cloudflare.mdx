...
export const description = 'Use dotenvx with Cloudflare Workers & Pages'

<PlatformsBreadcrumb platform="Cloudflare Workers & Pages" icon={<> <CloudflareIcon className="h-9 w-9 text-[#F38020]"/> </>} />
